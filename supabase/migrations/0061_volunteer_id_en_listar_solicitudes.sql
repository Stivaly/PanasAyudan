...
-- Expone volunteer_id en la respuesta de listar_solicitudes_disponibles para
-- que el frontend pueda filtrar su suscripcion Realtime de compromisos_voluntario
-- por dueno (issue #83), sin exponer nada nuevo a otros voluntarios: cada quien
-- solo recibe su propio id, resuelto igual que hoy a partir de su token.
